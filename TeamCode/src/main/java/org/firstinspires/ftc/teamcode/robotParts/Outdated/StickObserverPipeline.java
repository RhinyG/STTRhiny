...
public class StickObserverPipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        // lenient bounds will filter out near yellow, this should filter out all near specific color things(tune this if needed)
        Scalar lowHSV = new Scalar(0, 128, 0);
        ...
        Scalar strictLowHSV = new Scalar(0, strictLowS, 0); //strict lower bound HSV for color
        Scalar strictHighHSV = new Scalar(255, strictHighS, 255); //strict higher bound HSV for color
